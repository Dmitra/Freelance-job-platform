  ...
  this.addElement = function( element )
  	{if( element.tagName == 'INPUT' && element.type == 'file' )
		...
		element.onchange = function()
			...
			this.id = ""}; //'Pending attachments' field shouldn't have id of the newfile_data field which can be updated when removing 'saved attachments'
